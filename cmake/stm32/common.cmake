...
if(NOT STM32_TOOLCHAIN_PATH AND NOT ENV{STM32_TOOLCHAIN_PATH})
...
# If STM32_TOOLCHAIN_PATH is set as an environmental variable, search there for tools as well
set(TOOLS_SEARCH_PATH "${TOOLCHAIN_BIN_PATH}" "ENV" "STM32_TOOLCHAIN_PATH")
find_program(CMAKE_OBJCOPY NAMES ${STM32_TARGET_TRIPLET}-objcopy PATHS ${TOOLS_SEARCH_PATH} NO_DEFAULT_PATH)
find_program(CMAKE_OBJDUMP NAMES ${STM32_TARGET_TRIPLET}-objdump PATHS ${TOOLS_SEARCH_PATH} NO_DEFAULT_PATH)
find_program(CMAKE_SIZE NAMES ${STM32_TARGET_TRIPLET}-size PATHS ${TOOLS_SEARCH_PATH} NO_DEFAULT_PATH)
find_program(CMAKE_DEBUGGER NAMES ${STM32_TARGET_TRIPLET}-gdb PATHS ${TOOLS_SEARCH_PATH} NO_DEFAULT_PATH)
find_program(CMAKE_CPPFILT NAMES ${STM32_TARGET_TRIPLET}-c++filt PATHS ${TOOLS_SEARCH_PATH} NO_DEFAULT_PATH)
